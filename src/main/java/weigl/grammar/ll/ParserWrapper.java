...
import weigl.grammar.ll.rt.Parser;
import weigl.grammar.ll.rt.ParserFather;
...
public class ParserWrapper implements Parser
{
    ...
    public ParserWrapper(String javaSource) throws IOException, InstantiationException,
